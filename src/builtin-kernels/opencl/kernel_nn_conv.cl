...
__kernel void myGEMM1(const int M, const int K, const int N, int img_n,int glob_h_step,int glob_w_step,
    ...
    const int globalRow = glob_h_step*get_group_id(0)+row; // Row ID of C (0..M)
    const int globalCol = glob_w_step*get_group_id(1)+col; // Col ID of C (0..N)
